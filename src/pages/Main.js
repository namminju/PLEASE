...
function ProjectSection({ image, title, date, description, link }) {
  ...
  return (
    <div
      style={{
        ...
        cursor: "pointer", // 마우스 모양 변환
        transition: "transform 0.3s ease", // transform 효과에 애니메이션 추가
        transform: isHovered ? "scale(1.02)" : "scale(1)", // hover 시 요소가 살짝 커지게
      }}
      onClick={() => window.open(link, "_blank")} // 새 탭에서 링크 열기
      onMouseEnter={() => setIsHovered(true)} // hover 시작 시
      onMouseLeave={() => setIsHovered(false)} // hover 종료 시
...
<img
  ...
  style={{
    ...
    borderRadius: "10px",
    opacity: isHovered ? 1 : 1, // hover 시 이미지 어두워짐
    transition: "opacity 0.3s ease", // 이미지 투명도에 애니메이션 적용
  }}
/>
      ...
      <div
        style={{
          marginLeft: "1.2rem",
          fontSize: "clamp(16px, 1.2vw, 50px)",
          flex: 1,
          width: "100%",
        }}
      >
        <div
          style={{
            fontSize: "clamp(32px, 2.4vw, 160px)",
            fontWeight: "bold",
            textAlign: "right",
            width: "100%",
            color: isHovered ? "#fff" : "#fff", // hover 시 텍스트 색상 변경
        ...
        <div
          style={{
            fontSize: "clamp(16px, 1.2vw, 50px)",
            background: isHovered ? "rgba(0, 0, 0, 0.7)" : "white", // hover 시 배경 어두워짐
            color: isHovered ? "white" : "black", // hover 시 텍스트 색상 변경
            borderRadius: "10px",
            padding: "10% 5%",
            margin: "5% 0",
            width: "90%",
...
function SkillSection({ image, title, skills }) {
    ...
    return (
      ...
      >
        ...
        <ul style={{ marginLeft: "1rem" , opacity: isHovered ? 0.1 : 1,}}>
  ...
  const projects = [
    {
      ...
      link:"https://github.com/CSID-DGU/2023-2-OSSP2-ecoback-5",
   ...
   },
    {
      ...
      link:"https://github.com/GraduationProj-SmarkCare/SeniorSmarkCare",
    ...
    },
    {
      ...
      link:"https://github.com/DGU-GraduationDesign-Babhangongi/Dongguk-Air-in-Seoul",
    ...
    },
    {
        title: "Newsee",
        date:"2024년 9월 - 2024년 12월",
        link:"https://github.com/tteeyongPing/Frontend",
